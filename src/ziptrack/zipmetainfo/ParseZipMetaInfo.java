...
public class ParseZipMetaInfo {
	...
	public void processEvent(String line){
		...
		if(terminalMap.containsKey(idx)){
			...
			TerminalZipMetaInfo terminal = new TerminalZipMetaInfo("Term" + idx, eType, t, decor);
	...
	public NonTerminalZipMetaInfo processRule(String line){
		...
		NonTerminalZipMetaInfo nt = null;
		if(!nonTerminalMap.containsKey(nt_name)){
			nt = new NonTerminalZipMetaInfo("NTerm" + nt_name);
		...
		for(String symb_str : rule_str_lst){
			...
			if(symb_str.matches("^\\d+$")){
				...
				if(nonTerminalMap.containsKey(symb_str)){
					...
					symb = new NonTerminalZipMetaInfo("NTerm" + symb_str);
